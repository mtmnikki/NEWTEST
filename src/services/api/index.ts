...
import { runAirtableDiagnostics, testTableAccess, validateApiKeyFormat } from './test'
// Airtable service not used in demo mode
...
export const Api = {
   ...
   */
  runDiagnostics: runAirtableDiagnostics,

  /**
   * Test access to a specific table
   */
  testTableAccess: testTableAccess,
